(function($) {
    $.fn.window = function() {
        ...
        cartBtn.click(function() {
            ...
            var manifest = runManifest(url, this.parentElement.parentElement.id);
        ...
        this.append(btn);
        function runManifest(manifestUrl, element) {
            var run = {};
        ...
        function leafletMap(canvas, element) {
            ...
            var backgroundLabel = $('<div id = "backgroundLabel'+element+'" class="backgroundLabel scrollbar style-1"><span id="labelClose"> X </span></div>');
            $('#'+element).append(backgroundLabel);
            $('#backgroundLabel'+element).hide();
